;; domain file: domain-vaccum_cleaner_firstfloor.pddl
(define (domain vaccum_cleaner_firstfloor)
    (:requirements :strips)
    (:predicates
        (vaccum ?obj)
        (room ?before)
        ...
        (:action CleanAllRoomsFirstFloor
            :parameters (?obj ?r1 ?r2 ?r3 ?r4 ?r5 ?r6 ?r7 ?r8)
            :precondition (and
                (vaccum ?obj)
                (room1 ?r1)
                (room2 ?r2)
